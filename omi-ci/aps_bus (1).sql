...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2022 at 10:45 AM
...
(1, 5, '2022-02-01', '2022-02-28', 'cash payment', '449849651894', '750.00', 'monthly fee'),
(2, 4, '2022-02-01', '2022-02-28', 'cash payment', 'dd', '500.00', 'monthly fee');
...
INSERT INTO `fund_transfer` (`f_from`, `f_to`, `f_amount`, `pay_date`, `f_id`) VALUES
('2022-02-01', '2022-03-11', '1250.00', '2022-03-04', 1);
...
CREATE TABLE `pettycash` (
  ...
  `pcamount` decimal(10,2) NOT NULL,
...
INSERT INTO `pettycash` (`pcid`, `pcamount`, `paydate`) VALUES
(1, '500.00', '2022-03-18');
